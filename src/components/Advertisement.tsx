...
const Advertisement = ({ index }: AdvertisementProps) => {
  ...
  const handleAdClick = () => {
    if (currentAd) {
      ...
      // If it's the "Stay Connected" ad, show subscription modal
      if (currentAd.title === "Stay Connected" || currentAd.ctaText === "Subscribe") {
  ...
  const handleSubscribed = () => {
    // User successfully subscribed, the ad will disappear on next render
